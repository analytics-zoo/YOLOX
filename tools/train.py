...
def make_parser():
    ...
    # distributed
    parser.add_argument(
        "--dist-backend", default="spark", type=str, help="distributed backend"
    )
    parser.add_argument(
        "--dist-url",
        default=None,
...
if __name__ == "__main__":
    ...
    if args.cluster_mode == "local":
            init_orca_context(memory="4g",cores="*")
    elif args.cluster_mode.startswith("yarn"):
        if args.cluster_mode == "yarn-client":
            init_orca_context(cluster_mode="yarn-client",cores="*")
        elif args.cluster_mode == "yarn-cluster":
            init_orca_context(cluster_mode="yarn-cluster", memory=args.executor_memory, driver_memory=args.driver_memory,cores="*")
